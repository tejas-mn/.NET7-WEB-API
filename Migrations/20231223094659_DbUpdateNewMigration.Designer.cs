...
namespace asp_net_web_api.Migrations
{
    ...
    [Migration("20231223094659_DbUpdateNewMigration")]
    partial class DbUpdateNewMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.UserRole", b =>
                {
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.Product", b =>
                {
                    b.HasOne("asp_net_web_api.API.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.RolePermission", b =>
                {
                    b.HasOne("asp_net_web_api.API.Models.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("asp_net_web_api.API.Models.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("asp_net_web_api.API.Models.UserRole", b =>
                {
                    ...
                    b.HasOne("asp_net_web_api.API.Models.User", "User")
                        .WithMany("UserRoles")
